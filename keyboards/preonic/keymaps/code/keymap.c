...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT_preonic_grid(
        XXXXXXX, KC_PSCR, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_NUM , KC_PSLS, KC_PAST, KC_PMNS, _______,
    ...
    [_RAISE] = LAYOUT_preonic_grid(
        ...
        _______, KC_DLR , KC_AT  , KC_BSLS, KC_UNDS, XXXXXXX, XXXXXXX, KC_ASTR, KC_SLSH, KC_PERC, KC_QUES, XXXXXXX,
